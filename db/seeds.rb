...
@test1 = @backend.tests.create(title: 'Ruby', level: 0, user: @user1)
@test2 = @backend.tests.create(title: 'Rails', level: 2, user: @user2)
@test3 = @frontend.tests.create(title: 'JavaScript', level: 1, user: @user2)
@test4 = @frontend.tests.create(title: 'HTML', level: 0, user: @user1)
@test5 = @frontend.tests.create(title: 'CSS', level: 1, user: @user2)
